...
const contractABI = require("../artifacts/contracts/Mirthbridge.sol/Mirthbridge.json").abi;

program
    .name("mirthbridge-cli")
    .description("CLI tool for Mirthbridge smart contract")
    .version("1.0.0");

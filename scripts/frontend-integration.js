 ...
 * This file demonstrates how to integrate Mirthbridge with a web frontend
 */

// For React/Vue/Angular applications
export class MirthbridgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MirthbridgeClient(provider, contractAddress);
